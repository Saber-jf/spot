      ...
      <div>
        ...
        <div>
          <div className=" flex justify-center ">
            <Image src="/camasir-model.jpg" alt="me" width={612} height={408} />
          </div>
          <div className="p-4 max-w-[800px] mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-6 mt-8 gap-4">
              <Tag
                link={"/camasir-makinesi"}
                value={[
                  { tag: "2.el Çamaşır Makinesi Modeleri" },
                  { tag: " 2.el Çamaşır Makinesi alim" },
                  { tag: "kadıköy de 2.el Çamaşır Makinesi" },
                  { tag: "ikinci el eşya alim satim" },
                  { tag: "2.el Çamaşır Makinesi satim" },
